...
public class ChaseState : EnemyBaseState
{
    ...
    private bool _useMovePrediction; // just for test when comparison without prediction 
    #endregion

    #region Constructor 
    public ChaseState(Enemy enemy, NavMeshAgent agent, PlayerController player, FieldOfView fov, EnemyStatsSO statsSO, bool usePrediction) : base(enemy)
    {
        this._navMeshAgent = agent;
        this._player = player;
        this._fov = fov;
        this._statsSO = statsSO;
        this._useMovePrediction = usePrediction;
    }
    #endregion
